...
const CartItem = ({ item, removeItemFromCart }) => {
    ...
    return (
        <Component>
            ...
            <Box style={{ margin: 20 }}>
                <Typography>Varma accepted to Review this Product</Typography>
                <SmallText><NotificationButton>Contact him</NotificationButton>
                ...
                {/* <Remove onClick={() => removeItemFromCart(item.id)}>Accept</Remove>
                <Remove onClick={() => removeItemFromCart(item.id)}>Reject</Remove> */}
            </Box>
        </Component>
    )
}
